...
namespace Gero.API.Migrations
{
    ...
    [Migration("20181005214531_CreateBonusType")]
    partial class CreateBonusType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gero.API.Models.BonusType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("NextBonusTypeId");

                    b.Property<int?>("PreviousBonusTypeId");
                    ...
                    b.HasIndex("NextBonusTypeId")
                        .IsUnique()
                        .HasFilter("[NextBonusTypeId] IS NOT NULL");

                    b.ToTable("BonusTypes","DISTRIBUCION");
                });
            ...
            modelBuilder.Entity("Gero.API.Models.BonusType", b =>
                {
                    b.HasOne("Gero.API.Models.BonusType", "NextBonusType")
                        .WithOne("PreviousBonusType")
                        .HasForeignKey("Gero.API.Models.BonusType", "NextBonusTypeId");
                });
