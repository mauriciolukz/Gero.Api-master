...
namespace Gero.API.Migrations
{
    ...
    [Migration("20180927144114_AddApproverTypeSeed")]
    partial class AddApproverTypeSeed
    {
            ...
            modelBuilder.Entity("Gero.API.Models.ApproverType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "mobile_applicant", Name = "Solicitante Móvil" },
                        new { Id = 2, Code = "web_applicant", Name = "Solicitante Web" },
                        new { Id = 3, Code = "checker", Name = "Verificador" },
                        new { Id = 4, Code = "approver", Name = "Aprobador" },
                        new { Id = 5, Code = "master_approver", Name = "Aprobador Superior" }
                    );
                });
